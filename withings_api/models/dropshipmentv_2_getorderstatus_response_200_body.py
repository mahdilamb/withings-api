...
T = TypeVar("T", bound="Dropshipmentv2GetorderstatusResponse200Body")


@_attrs_define
class Dropshipmentv2GetorderstatusResponse200Body:
    """Response data.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        dropshipmentv_2_getorderstatus_response_200_body = cls(
            orders=orders,
        )

        dropshipmentv_2_getorderstatus_response_200_body.additional_properties = d
        return dropshipmentv_2_getorderstatus_response_200_body
