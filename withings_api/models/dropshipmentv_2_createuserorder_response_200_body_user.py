...
T = TypeVar("T", bound="Dropshipmentv2CreateuserorderResponse200BodyUser")


@_attrs_define
class Dropshipmentv2CreateuserorderResponse200BodyUser:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        dropshipmentv_2_createuserorder_response_200_body_user = cls(
            code=code,
            external_id=external_id,
        )

        dropshipmentv_2_createuserorder_response_200_body_user.additional_properties = d
        return dropshipmentv_2_createuserorder_response_200_body_user
