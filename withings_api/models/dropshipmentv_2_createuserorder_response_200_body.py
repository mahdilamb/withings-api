...
if TYPE_CHECKING:
    ...
    from ..models.dropshipmentv_2_createuserorder_response_200_body_user import (
        Dropshipmentv2CreateuserorderResponse200BodyUser,
    )


T = TypeVar("T", bound="Dropshipmentv2CreateuserorderResponse200Body")


@_attrs_define
class Dropshipmentv2CreateuserorderResponse200Body:
    """Response data.
    ...
    Attributes:
        ...
        invalid_address_customer_ref_ids (Union[Unset, list[str]]): References of the orders with invalid address.
            *(Only if at least one order has an invalid address)* Example: ['MOUVEMENTREFERENCE12345678'].
        orders (Union[Unset, list['DropshipmentCreateOrderObject']]): List of created orders. *(Only if orders were
            successfully created)*
        user (Union[Unset, Dropshipmentv2CreateuserorderResponse200BodyUser]):
    """
    ...
    user: Union[Unset, "Dropshipmentv2CreateuserorderResponse200BodyUser"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_user, Unset):
            ...
            user = Dropshipmentv2CreateuserorderResponse200BodyUser.from_dict(_user)

        dropshipmentv_2_createuserorder_response_200_body = cls(
        ...
        dropshipmentv_2_createuserorder_response_200_body.additional_properties = d
        return dropshipmentv_2_createuserorder_response_200_body
