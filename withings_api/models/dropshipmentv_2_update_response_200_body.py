...
T = TypeVar("T", bound="Dropshipmentv2UpdateResponse200Body")


@_attrs_define
class Dropshipmentv2UpdateResponse200Body:
    """Response data.

    Attributes:
        orders (Union[Unset, list['DropshipmentCreateOrderObject']]):
    """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        dropshipmentv_2_update_response_200_body = cls(
            orders=orders,
        )

        dropshipmentv_2_update_response_200_body.additional_properties = d
        return dropshipmentv_2_update_response_200_body
